                ...
                <View style={styles.drawerContent}>
                    <View style={styles.userInfoSection}>
                        <View>
                            <Avatar.Image
                            soruce={{
                                uri: "https://cms-assets.tutsplus.com/uploads/users/151/posts/33726/image/biz-card.jpg"
                            }}
                            size={50}/>
                            <View>
                                <Title style={styles.title}>Ayush Kumar</Title>
                                <Caption style={styles.caption}>@ayush</Caption>
                            </View>
                        </View>
                    </View>
                    ...
                    <DrawerItem
                        icon={({color, size}) => (
                        <Icon.MaterialCommunityIcons name="cart"
                        color={color}
                        size={size}
